...
@Component({
  selector: 'app-historique-telephone',
  templateUrl: './historique-telephone.component.html',
  styleUrls: ['./historique-telephone.component.css']
})
export class HistoriqueTelephoneComponent {
