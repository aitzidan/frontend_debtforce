...
@Component({
  selector: 'app-historique-addresse',
  templateUrl: './historique-addresse.component.html',
  styleUrls: ['./historique-addresse.component.css']
})
export class HistoriqueAddresseComponent {
  constructor(private route: ActivatedRoute,
    private HistoService: HistoriqueService ,
    private router: Router
    ) { }
  list_models: Competence[] = []; // Change the type to PeriodicElement[]
  displayedColumns: string[] = [ 'numero', 'origine', 'id_status_id', 'id_type_adresse_id', 'id_users_id', 'note1', 'type', 'date_creation'];
