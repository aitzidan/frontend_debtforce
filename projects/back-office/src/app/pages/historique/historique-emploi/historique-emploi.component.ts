...
@Component({
  selector: 'app-historique-emploi',
  templateUrl: './historique-emploi.component.html',
  styleUrls: ['./historique-emploi.component.css']
})
export class HistoriqueEmploiComponent {
