document.addEventListener("DOMContentLoaded", function(){
    ...
    function snapping(drag, first) {
        ...
        if (drag.querySelector(".blockelemtype").value == "1") {
            ...
            drag.innerHTML += "<div class='blockyleft'><img src='assets/errorred.svg'><p class='blockyname'>cccccccccccc</p></div><div class='blockyright'><img src='assets/more.svg'></div><div class='blockydiv'></div><div class='blockyinfo'>Trigger <span>Error 12</span></div>";
        }
        return true;
    }
    function drag(block) {
